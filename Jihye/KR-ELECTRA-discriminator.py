...
if __name__ == '__main__':
    ...
    wandb_logger = WandbLogger(name="KR-ELECTRA-discriminator", project="sts_04")
    cfg = {
    ...
    checkpoint_callback = ModelCheckpoint(
        ...
        monitor="val_pearson",
        mode="max",
        dirpath="./model/KR-ELECTRA-discriminator/", 
    ...
    # 학습이 완료된 모델을 저장합니다.
    torch.save(model, './model/KR-ELECTRA-discriminator/model.pt')
